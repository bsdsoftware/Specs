Pod::Spec.new do |s|
  ...
  s.source                = { :git => 'https://github.com/bsdsoftware/appirater.git', :tag => '3.0.2' }
  s.source_files          = '*.{h,m}'
  s.resource_bundles      = { 'Appirater' => ['*.lproj'] }
  s.requires_arc          = true
  s.frameworks            = 'CFNetwork', 'SystemConfiguration'
  s.weak_framework        = 'StoreKit'
  s.license               = { :type => 'MIT', :text => 'Copyright 2015. BSDSoftware. This library is distributed under the terms of the MIT/X11.' }
end
